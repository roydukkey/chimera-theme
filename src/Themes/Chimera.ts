...
export default class Chimera extends Schema {
	...
	constructor () {
		...
		this.colors = {
			...
			'editor.findMatchBackground': Colors.findMatchBackground,
			'editor.findMatchBorder': Colors.findMatchBorder,
			'editor.findMatchHighlightBackground': Colors.findMatchHighlightBackground,
			'editor.findMatchHighlightBorder': Colors.findMatchHighlightBorder,
			'editor.foldBackground': Colors['editor.foldBackground'],
			'editor.foreground': Colors.foreground,
			'editor.hoverHighlightBackground': Colors.hoverHighlightBackground,
			'editor.lineHighlightBorder': Colors.lineHighlightBorder,
			'editor.rangeHighlightBackground': Colors.rangeHighlightBackground,
			...
			'editor.wordHighlightStrongBackground': Colors.wordHighlightStrongBackground,
			...
			'editorOverviewRuler.wordHighlightForeground': Colors.wordHighlightBackground,
			'editorOverviewRuler.wordHighlightStrongForeground': Colors.wordHighlightStrongBackground,
			...
			'terminal.selectionBackground': Colors.selectionBackground,
			'terminal.findMatchBackground': Colors.findMatchBackground,
			...
			'terminal.ansiBrightBlack': Colors.vibrantBlack1,
			'terminal.ansiBrightBlue': Colors.vibrantPurple1,
			'terminal.ansiBrightCyan': Colors.vibrantCyan1,
			'terminal.ansiBrightGreen': Colors.vibrantGreen1,
			'terminal.ansiBrightMagenta': Colors.vibrantPink1,
			'terminal.ansiBrightRed': Colors.vibrantRed1,
			'terminal.ansiBrightWhite': Colors.vibrantWhite1,
			'terminal.ansiBrightYellow': Colors.vibrantYellow1,
